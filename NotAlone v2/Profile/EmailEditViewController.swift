//
//  EmailEditViewControllerViewController.swift
//  NotAlone v2
//
...
class EmailEditViewController: UIViewController {
    ...
    private lazy var textField: UITextField = {
        ...
        textField.placeholder = "Укажите email"
        textField.setup()
        return textField
    }()
    ...
    deinit {
        print("DEINIT EmailEditViewController")
    }
...
extension EmailEditViewController: UITextFieldDelegate {
